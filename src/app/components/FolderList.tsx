...
export default function FolderList({ folders, onSelectFolder }: { folders: any[], onSelectFolder: (id: string) => void }) {
  return (
    <div className="mb-6">
      <div className="flex justify-between items-center mb-2">
        <h4 className="text-md font-semibold">Folders</h4>
        <button className="text-blue-600 text-sm" disabled>Add Folder</button>
      </div>
      {folders.length === 0 ? (
